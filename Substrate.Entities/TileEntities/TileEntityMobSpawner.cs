...
namespace Substrate.TileEntities
{
    ...
    public class TileEntityMobSpawner : TileEntity
    {
        public static readonly SchemaNodeCompound MobSpawnerSchema = TileEntity.Schema.MergeInto(new SchemaNodeCompound("")
        {
            ...
            new SchemaNodeScalar("MaxExperience", TagType.TAG_INT, SchemaOptions.OPTIONAL),
            new SchemaNodeScalar("RemainingExperience", TagType.TAG_INT, SchemaOptions.OPTIONAL),
            new SchemaNodeScalar("ExperienceRegenTick", TagType.TAG_INT, SchemaOptions.OPTIONAL),
            new SchemaNodeScalar("ExperienceRegenRate", TagType.TAG_INT, SchemaOptions.OPTIONAL),
            new SchemaNodeScalar("ExperienceRegenAmount", TagType.TAG_INT, SchemaOptions.OPTIONAL),
